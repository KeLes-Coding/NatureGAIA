...
# from config import TD_API_KEY,TD_API_URL,TD_MODEL,MAE_MODEL
...
if BACKBONE_TYPE == "OpenAI":
    REASONING_MODEL = "Qwen2.5-VL-7B-Instruct"
    KNOWLEDGE_REFLECTION_MODEL = "Qwen2.5-VL-7B-Instruct"
    ANSWER_MODEL = "qwen-max-2025-01-25"
elif BACKBONE_TYPE == "Gemini":
    REASONING_MODEL = "o3"
    KNOWLEDGE_REFLECTION_MODEL = "o3"
    ANSWER_MODEL = "qwen-max-2025-01-25"
elif BACKBONE_TYPE == "Claude":
    REASONING_MODEL = ""
    KNOWLEDGE_REFLECTION_MODEL = ""
    ANSWER_MODEL = ""
...
# CAPTION_MODEL = "google/gemini-2.5-pro-preview"
CAPTION_MODEL = ""
